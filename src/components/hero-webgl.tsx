...
export const Hero3DWebGL = () => {
  const titleWords = "Lingua AI".split(" ")
  const subtitle = "Учи языки быстрее с искусственным интеллектом."
  ...
  return (
    <div className="h-screen bg-black relative overflow-hidden">
      ...
      <div className="h-screen uppercase items-center w-full absolute z-[60] pointer-events-none px-4 sm:px-10 flex justify-center flex-col">
        ...
        <div className="text-sm sm:text-base md:text-xl xl:text-2xl 2xl:text-3xl mt-2 overflow-hidden text-white font-bold max-w-4xl mx-auto text-center px-4">
          <div
